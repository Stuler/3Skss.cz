...
/** source: C:\WWW\3Skss.cz\Web\app\AdminModule\Presenters/templates/Dashboard/default.latte */
final class Template3afe099be6 extends Latte\Runtime\Template
{
...
';
		...
		if ($user->isLoggedIn()) /* line 11 */ {
			echo '<p><a href="';
			echo LR\Filters::escapeHtmlAttr($this->global->uiControl->link("signOut")) /* line 11 */;
			echo '">Odhlásit</a></p>
';
		}
		echo "\n";
