...
class Container_b5da6ea574 extends Nette\DI\Container
{
	...
	public function createServiceContainer(): Container_b5da6ea574
	{
		return $this;
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			...
			public function __construct(Container_b5da6ea574 $container)
			{
	...
	public function createServiceMigrations__group__basicData(): Nextras\Migrations\Entities\Group
	{
		...
		$service->directory = '/Users/anythingdev/Sites/3Skss.cz/Web/app/migrations/basic-data';
	...
	public function createServiceMigrations__group__dummyData(): Nextras\Migrations\Entities\Group
	{
		...
		$service->enabled = true;
		$service->directory = '/Users/anythingdev/Sites/3Skss.cz/Web/app/migrations/dummy-data';
	...
	public function createServiceMigrations__group__structures(): Nextras\Migrations\Entities\Group
	{
		...
		$service->enabled = true;
		$service->directory = '/Users/anythingdev/Sites/3Skss.cz/Web/app/migrations/structures';
